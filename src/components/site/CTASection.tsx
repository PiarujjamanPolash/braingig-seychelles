...
const CTASection = ({
  ...
  <section id="contact" className="relative overflow-hidden bg-background px-6 py-16 md:px-10 md:py-36">
    ...
    <div className="relative mx-auto max-w-7xl">
      <Reveal>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 font-display text-[clamp(2.4rem,5.5vw,4.6rem)] font-semibold leading-[1.05] text-ink text-balance md:mt-6">
            {title} <span className="font-normal text-coral">{highlight}</span>
          </h2>
          <p className="mt-4 text-muted-foreground md:mt-6 md:text-lg">{text}</p>
          <div className="mt-6 inline-flex items-center gap-3 rounded-full border border-border bg-card px-5 py-2.5 shadow-soft md:mt-8">
      ...
      <Reveal y={50} className="mt-8 md:mt-14">
        <CalendlyEmbed />
      </Reveal>
    </div>
  </section>
